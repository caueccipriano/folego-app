-- Applied to Supabase as migration 20260914205340_align_monthly_recurring_schedule_in_folego_snapshot.
-- Scope: align monthly recurring schedule expansion in Fôlego with get_upcoming_events.
-- No recurring data or historical financial data is rewritten.
