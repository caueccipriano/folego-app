-- Applied to Supabase as migration 20260917175512_exclude_benefit_from_folego_spendable_pool.
-- Scope: keep benefit_expense budget/economic ledger dimensions for traceability,
-- but exclude benefit_expense from the budget usage projection that constrains Fôlego.
-- No historical financial data or ledger rows are rewritten.
